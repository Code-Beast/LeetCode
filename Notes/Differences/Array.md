...
| Index                   | myList[0] # 'physics'<br>myList[-1] # 2000                   | tup1[0] # cannot change                                      | #                                                            | myCars[0]                                                    | arr[0]                                                       |
